...
public class JwtTokenProvider {
    private String secretKey = "secret"; // JWT 토큰을 서명하고 검증하는 데 사용되는 비밀 키 (초기값은 "secret", Base64로 인코딩)
    private final long validityInMilliseconds = 3600000; // 토큰의 유효 시간 (1시간)을 밀리초 단위로 설정
